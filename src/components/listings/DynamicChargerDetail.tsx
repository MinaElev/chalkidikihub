...
export function DynamicChargerDetail({ slug }: { slug: string }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        address: {
          '@type': 'PostalAddress',
          addressLocality: charger.location_name,
        ...
        amenityFeature: charger.connectors.map((c) => ({
          '@type': 'LocationFeatureSpecification',
          name: `${c.type} ${c.power_kw}kW`,
          value: true,
        })),
      })}} />
    </div>
