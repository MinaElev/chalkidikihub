...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/seo-gsc', icon: BarChart3, label: 'SEO – Search Console' },
      { href: '/admin/monthly-report', icon: Mail, label: 'Monthly Owner Report' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/announce-reviews', icon: Star, label: 'Ανακοίνωση Κριτικών' },
