...
export default function EditBlogPage() {
  ...
  const [form, setForm] = useState({
    ...
    content_el: '', content_en: '', content_de: '', content_bg: '', content_ru: '', content_ro: '', content_sr: '',
    ...
    published_at: '',
    title_de: '', title_bg: '', title_ru: '', title_ro: '', title_sr: '',
    excerpt_de: '', excerpt_bg: '', excerpt_ru: '', excerpt_ro: '', excerpt_sr: '',
    ...
    async function load() {
      ...
      if (data) {
        setForm({
          ...
          content_de: data.content_de || '', content_bg: data.content_bg || '', content_ru: data.content_ru || '', content_ro: data.content_ro || '', content_sr: data.content_sr || '',
          ...
          title_de: data.title_de || '', title_bg: data.title_bg || '', title_ru: data.title_ru || '', title_ro: data.title_ro || '', title_sr: data.title_sr || '',
          excerpt_de: data.excerpt_de || '', excerpt_bg: data.excerpt_bg || '', excerpt_ru: data.excerpt_ru || '', excerpt_ro: data.excerpt_ro || '', excerpt_sr: data.excerpt_sr || '',
          ...
          meta_title_ru: data.meta_title_ru || '', meta_title_ro: data.meta_title_ro || '', meta_title_sr: data.meta_title_sr || '',
          ...
          meta_description_ru: data.meta_description_ru || '', meta_description_ro: data.meta_description_ro || '', meta_description_sr: data.meta_description_sr || '',
