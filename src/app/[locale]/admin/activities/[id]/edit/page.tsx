...
export default function EditActivityPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    revalidateContent('activities', form.slug as string);
  }
        ...
        <AIHelper
          ...
          onComplete={(data) => {
            setForm((prev) => ({
              ...
              name_ru: data.translations.title_ru, name_ro: data.translations.title_ro, name_sr: data.translations.title_sr && data.translations.title_sr !== 'undefined' ? data.translations.title_sr : '',
