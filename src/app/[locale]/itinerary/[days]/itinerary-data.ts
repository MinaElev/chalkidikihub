...
export const ITINERARIES: ItineraryGuide[] = [
  {
    ...
    metaTitle: {
      el: '3 Μέρες στη Χαλκιδική — Πρόγραμμα | ChalkidikiHub',
      en: '3 Days in Halkidiki — Itinerary | ChalkidikiHub',
      de: '3 Tage in Chalkidiki — Reiseplan | ChalkidikiHub',
      bg: '3 Дни в Халкидики — Маршрут | ChalkidikiHub',
      ru: '3 Дня в Халкидики — Маршрут | ChalkidikiHub',
      ro: '3 Zile in Halkidiki — Itinerar | ChalkidikiHub',
      sr: '3 Dana u Halkidikiju — Plan | ChalkidikiHub',
    },
    metaDesc: {
...
<li>Pogledajte <a href="/faq/transport">FAQ o prevozu</a></li>
...

  {
    ...
    metaTitle: {
      el: '5 Μέρες στη Χαλκιδική — Πρόγραμμα | ChalkidikiHub',
      en: '5 Days in Halkidiki — Itinerary | ChalkidikiHub',
      de: '5 Tage in Chalkidiki — Reiseplan | ChalkidikiHub',
      bg: '5 Дни в Халкидики — Маршрут | ChalkidikiHub',
      ru: '5 Дней в Халкидики — Маршрут | ChalkidikiHub',
      ro: '5 Zile in Halkidiki — Itinerar | ChalkidikiHub',
      sr: '5 Dana u Halkidikiju — Plan | ChalkidikiHub',
    },
    metaDesc: {
...
<li>Rezervisite <a href="/listings">smestaj</a> rano</li>
...

  {
    ...
    metaTitle: {
      el: '7 Μέρες στη Χαλκιδική — Πρόγραμμα | ChalkidikiHub',
      en: '7 Days in Halkidiki — Itinerary | ChalkidikiHub',
      de: '7 Tage in Chalkidiki — Reiseplan | ChalkidikiHub',
      bg: '7 Дни в Халкидики — Маршрут | ChalkidikiHub',
      ru: '7 Дней в Халкидики — Маршрут | ChalkidikiHub',
      ro: '7 Zile in Halkidiki — Itinerar | ChalkidikiHub',
      sr: '7 Dana u Halkidikiju — Plan | ChalkidikiHub',
    },
    metaDesc: {
...
<li><strong>Izleti:</strong> €50-100</li>
...

  {
    ...
    metaTitle: {
      el: '10 Μέρες στη Χαλκιδική — Πρόγραμμα | ChalkidikiHub',
      en: '10 Days in Halkidiki — Itinerary | ChalkidikiHub',
      de: '10 Tage in Chalkidiki — Reiseplan | ChalkidikiHub',
      bg: '10 Дни в Халкидики — Маршрут | ChalkidikiHub',
      ru: '10 Дней в Халкидики — Маршрут | ChalkidikiHub',
      ro: '10 Zile in Halkidiki — Itinerar | ChalkidikiHub',
      sr: '10 Dana u Halkidikiju — Plan | ChalkidikiHub',
    },
    metaDesc: {
...
<li><strong>Izleti:</strong> €80-150</li>
...

  {
    ...
    metaTitle: {
      el: 'Σαββατοκύριακο στη Χαλκιδική — Πρόγραμμα | ChalkidikiHub',
      en: 'Weekend Getaway to Halkidiki — Itinerary | ChalkidikiHub',
      de: 'Wochenendausflug Chalkidiki — Reiseplan | ChalkidikiHub',
      bg: 'Уикенд в Халкидики — Маршрут | ChalkidikiHub',
      ru: 'Выходные в Халкидики — Маршрут | ChalkidikiHub',
      ro: 'Weekend in Halkidiki — Itinerar | ChalkidikiHub',
      sr: 'Vikend u Halkidikiju — Plan | ChalkidikiHub',
    },
    metaDesc: {
