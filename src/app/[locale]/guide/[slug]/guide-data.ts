...
export const GUIDES: Guide[] = [
  {
    ...
    metaTitle: { el: 'Καλοκαίρι στη Χαλκιδική — Οδηγός', en: 'Summer in Halkidiki — Guide', de: 'Sommer in Chalkidiki — Reiseführer', bg: 'Лято в Халкидики — Пътеводител', ru: 'Лето в Халкидики — Путеводитель', ro: 'Vara în Halkidiki — Ghid' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Πάσχα στη Χαλκιδική', en: 'Easter in Halkidiki', de: 'Ostern in Chalkidiki', bg: 'Великден в Халкидики', ru: 'Пасха в Халкидики', ro: 'Paștele în Halkidiki' },
  ...
  // ── Monthly guides ──
  {
    ...
    metaTitle: { el: 'Χαλκιδική τον Ιούνιο — Καιρός, Παραλίες, Tips', en: 'Halkidiki in June — Weather, Beaches, Tips', de: 'Chalkidiki im Juni — Wetter, Strände, Tipps', bg: 'Халкидики през юни — Време, Плажове', ru: 'Халкидики в июне — Погода, Пляжи', ro: 'Halkidiki în iunie — Vreme, Plaje', sr: 'Halkidiki u junu — Vreme, Plaže' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Χαλκιδική Σεπτέμβριο — Ο Καλύτερος Μήνας;', en: 'Halkidiki in September — The Best Month?', de: 'Chalkidiki September — Der beste Monat?', bg: 'Халкидики септември — Най-добрият месец?', ru: 'Халкидики сентябрь — Лучший месяц?', ro: 'Halkidiki septembrie — Cea mai bună lună?', sr: 'Halkidiki septembar — Najbolji mesec?' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Κασσάνδρα ή Σιθωνία; Πλήρης Σύγκριση', en: 'Kassandra or Sithonia? Full Comparison', de: 'Kassandra oder Sithonia? Vergleich', bg: 'Касандра или Ситония? Сравнение', ru: 'Кассандра или Ситония? Сравнение', ro: 'Kassandra sau Sithonia? Comparație', sr: 'Kasandra ili Sitonija? Poređenje' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Καιρός Χαλκιδική — Θερμοκρασίες, Βροχές, Θάλασσα', en: 'Halkidiki Weather — Temperatures, Rain, Sea Temp', de: 'Chalkidiki Wetter — Temperaturen, Regen, Meertemp.', bg: 'Времето в Халкидики — Температури, дъжд, море', ru: 'Погода Халкидики — Температура, дождь, море', ro: 'Vremea Halkidiki — Temperaturi, ploaie, mare', sr: 'Vreme Halkidiki — Temperature, kiša, more' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Ξενοδοχεία Χαλκιδικής — Πού να Μείνετε', en: 'Halkidiki Hotels — Where to Stay', de: 'Chalkidiki Hotels — Wo übernachten', bg: 'Хотели Халкидики — Къде да отседнете', ru: 'Отели Халкидики — Где остановиться', ro: 'Hoteluri Halkidiki — Unde să stați', sr: 'Hoteli Halkidiki — Gde odsjesti' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Ενοικίαση Αυτοκινήτου Χαλκιδική — Οδηγός', en: 'Car Rental Halkidiki — Complete Guide', de: 'Mietwagen Chalkidiki — Kompletter Führer', bg: 'Коли под наем Халкидики — Пълен гид', ru: 'Аренда авто Халкидики — Полный гид', ro: 'Închiriere auto Halkidiki — Ghid complet', sr: 'Rent-a-car Halkidiki — Kompletan vodič' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Camping Χαλκιδική — Καλύτερα Campings', en: 'Camping Halkidiki — Best Campgrounds', de: 'Camping Chalkidiki — Beste Campingplätze', bg: 'Къмпинг Халкидики — Най-добри къмпинги', ru: 'Кемпинг Халкидики — Лучшие кемпинги', ro: 'Camping Halkidiki — Cele mai bune campinguri', sr: 'Kampovanje Halkidiki — Najbolji kampovi' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Χωριά Χαλκιδικής — Άφυτος, Νικήτη, Παρθενώνας', en: 'Halkidiki Villages — Afytos, Nikiti, Parthenonas', de: 'Chalkidiki Dörfer — Afytos, Nikiti, Parthenonas', bg: 'Села Халкидики — Афитос, Никити, Партенонас', ru: 'Деревни Халкидики — Афитос, Никити, Партенонас', ro: 'Sate Halkidiki — Afytos, Nikiti, Parthenonas', sr: 'Sela Halkidikija — Afitos, Nikiti, Partenonas' },
  ...
  },
  {
    ...
    metaTitle: { el: 'Χάρτης Χαλκιδικής — Γεωγραφία & Αποστάσεις', en: 'Halkidiki Map — Geography & Distances', de: 'Chalkidiki Karte — Geografie & Entfernungen', bg: 'Карта Халкидики — География и разстояния', ru: 'Карта Халкидики — География и расстояния', ro: 'Harta Halkidiki — Geografie și distanțe', sr: 'Mapa Halkidikija — Geografija i rastojanja' },
...
<ul>
  ...
  },
  {
    ...
    metaTitle: {
      el: 'Χαλκιδική ή Θάσος 2026 — Σύγκριση Παραλιών, Τιμών, Πρόσβασης',
      en: 'Halkidiki vs Thassos 2026 — Beaches, Prices & Access Compared',
      de: 'Chalkidiki vs. Thassos 2026 — Strände, Preise, Anreise',
      bg: 'Халкидики или Тасос 2026 — Плажове, Цени, Достъп',
      ru: 'Халкидики или Тасос 2026 — Пляжи, Цены, Доступ',
      ro: 'Halkidiki sau Thassos 2026 — Plaje, Prețuri, Acces',
      sr: 'Halkidiki ili Tasos 2026 — Plaže, Cene, Pristup',
    },
    metaDesc: {
...
<p>Tradicionalno planinsko selo sa kamenom arhitekturom. Poznato po subotnjoj pijaci sa medom, maslinovim uljem i tekstilom.</p>`,
...

  {
    ...
    metaTitle: {
      el: '10 Καλύτερα Ηλιοβασιλέματα Χαλκιδικής (+ Μπαρ με Θέα)',
      en: '10 Best Sunset Spots in Halkidiki (+ Bars with a View)',
      de: '10 Beste Sonnenuntergangs-Orte in Chalkidiki (+ Bars mit Aussicht)',
      bg: '10 Най-добри места за залез в Халкидики (+ Барове с гледка)',
      ru: '10 Лучших мест для заката в Халкидиках (+ Бары с видом)',
      ro: '10 Cele mai bune locuri pentru apus în Halkidiki (+ Baruri)',
      sr: '10 Najlepših zalazaka u Halkidikiju (+ Barovi sa pogledom)',
    },
    metaDesc: {
...
<li><strong>Supermarketi:</strong> Lidl, AB, Masoutis — odlično maslinovo ulje po veoma niskim cenama</li>
  ...
  {
    slug: 'halkidiki-vs-skiathos', icon: 'Scale', color: 'teal',
    title: { el: 'Χαλκιδική ή Σκιάθος;', en: 'Halkidiki vs Skiathos', de: 'Chalkidiki oder Skiathos?', bg: 'Халкидики или Скиатос?', ru: 'Халкидики или Скиатос?', ro: 'Halkidiki sau Skiathos?', sr: 'Halkidiki ili Skiatos?' },
    description: { el: 'Χερσόνησος ή νησί των Σποράδων — ποιο σας ταιριάζει', en: 'Mainland peninsula vs Sporades island — which suits you', de: 'Festland-Halbinsel vs Sporaden-Insel', bg: 'Полуостров или остров от Спорадите', ru: 'Полуостров или остров Спорадских островов', ro: 'Peninsulă continentală sau insulă din Sporade', sr: 'Kopneni poluotok ili ostrvo Sporada' },
    metaTitle: { el: 'Χαλκιδική ή Σκιάθος 2026 — Πλήρης Σύγκριση', en: 'Halkidiki vs Skiathos 2026 — Full Comparison Guide', de: 'Chalkidiki vs Skiathos 2026 — Vergleich', bg: 'Халкидики или Скиатос 2026 — Сравнение', ru: 'Халкидики или Скиатос 2026 — Сравнение', ro: 'Halkidiki sau Skiathos 2026 — Comparație', sr: 'Halkidiki ili Skiatos 2026 — Poređenje' },
    metaDesc: { el: 'Χαλκιδική ή Σκιάθος; Παραλίες, πρόσβαση, κόστος, οικογένειες — πλήρης σύγκριση 2026.', en: 'Halkidiki or Skiathos? Beaches, access, cost, families — full 2026 comparison.', de: 'Chalkidiki oder Skiathos? Strände, Anreise, Kosten — Vergleich 2026.', bg: 'Халкидики или Скиатос? Плажове, достъп — пълно сравнение 2026.', ru: 'Халкидики или Скиатос? Пляжи, доступ — сравнение 2026.', ro: 'Halkidiki sau Skiathos? Plaje, acces — comparație 2026.', sr: 'Halkidiki ili Skiatos? Plaže, pristup — poređenje 2026.' },
    content: {
      el: `<h2>Χαλκιδική ή Σκιάθος;</h2><p>Δύο top προορισμοί με πευκόφυτες παραλίες. Η <strong>Σκιάθος</strong> είναι μικρό νησί των Σποράδων (49 km²) γνωστό για το Κουκουναριές και τη νυχτερινή ζωή. Η <strong>Χαλκιδική</strong> είναι ηπειρωτική χερσόνησος με 3 πόδια και ~500 χλμ ακτογραμμή.</p><h2>Πρόσβαση</h2><p>Χαλκιδική κερδίζει: 1 ώρα από SKG, χωρίς ferry. Σκιάθος: πτήση JSI ή ferry από Βόλο (~2,5h).</p><h2>Παραλίες</h2><p>Σκιάθος: 62 παραλίες σε μικρό χώρο. Χαλκιδική: πάνω από <a href="/beaches">100 παραλίες</a> με μεγάλη ποικιλία — από <a href="/best/beaches-sithonia">τη Σιθωνία</a> έως οικογενειακές της Κασσάνδρας.</p><h2>Κόστος</h2><p>Σκιάθος 20-30% ακριβότερη τον Ιούλιο-Αύγουστο. Χαλκιδική καλύτερη value για <a href="/listings">καταλύματα</a>.</p><h2>Οικογένειες</h2><p>Χαλκιδική ιδανικότερη. <a href="/guide/families">Οδηγός οικογενειών</a>.</p><h2>Νυχτερινή ζωή</h2><p>Σκιάθος Town legendary. Χαλκιδική: Καλλιθέα/Χανιώτη ζωντανές.</p><h2>Ποιος νικάει;</h2><p><strong>Παιδιά + budget</strong> → Χαλκιδική. <strong>Party + Insta</strong> → Σκιάθος.</p>`,
      en: `<h2>Halkidiki vs Skiathos</h2><p>Two top destinations with pine-fringed beaches. <strong>Skiathos</strong> is a small Sporades island (49 km²) famous for Koukounaries and buzzing nightlife. <strong>Halkidiki</strong> is a mainland peninsula with three legs and ~500 km of coastline.</p><h2>Access</h2><p>Halkidiki wins: 1 hour from SKG, no ferry. Skiathos requires JSI flight or 2.5h ferry from Volos.</p><h2>Beaches</h2><p>Skiathos packs 62 beaches in a small area. Halkidiki has <a href="/beaches">100+ beaches</a> with more variety — from <a href="/best/beaches-sithonia">Sithonia's hidden coves</a> to Kassandra's family bays.</p><h2>Cost</h2><p>Skiathos 20-30% pricier in July-August. Halkidiki better value for <a href="/listings">accommodation</a>.</p><h2>Families</h2><p>Halkidiki better suited. See our <a href="/guide/families">family guide</a>.</p><h2>Nightlife</h2><p>Skiathos Town legendary clubs. Halkidiki: Kallithea and Hanioti lively but family-friendly.</p><h2>Who wins?</h2><p><strong>Kids + budget</strong> → Halkidiki. <strong>Party + Insta</strong> → Skiathos.</p>`,
      de: `<h2>Chalkidiki oder Skiathos?</h2><p>Beide mit kieferngesäumten Stränden. Skiathos (49 km²) ist klein und partyfreudig. Chalkidiki hat 3 "Beine" und 500 km Küste.</p><h2>Anreise</h2><p>Chalkidiki: 1 Std. ab SKG, keine Fähre. Skiathos: JSI-Flug oder Fähre aus Volos.</p><h2>Strände</h2><p>Chalkidiki bietet mehr Vielfalt mit <a href="/beaches">100+ Stränden</a>.</p><h2>Kosten</h2><p>Skiathos 20-30% teurer im Hochsommer.</p><h2>Familien</h2><p>Chalkidiki klar besser geeignet.</p><h2>Wer gewinnt?</h2><p>Familien & Budget → Chalkidiki. Party → Skiathos.</p>`,
      bg: `<h2>Халкидики или Скиатос?</h2><p>Скиатос (49 км²) — малък остров от Спорадите. Халкидики — полуостров с 3 "крака" и 500 км брегова линия.</p><h2>Достъп</h2><p>Халкидики: 1 час от SKG, без ферибот. Скиатос: полет JSI или ферибот от Волос.</p><h2>Плажове</h2><p>Халкидики има повече разнообразие с <a href="/beaches">100+ плажа</a>.</p><h2>Цена</h2><p>Скиатос 20-30% по-скъп лятото.</p><h2>Семейства</h2><p>Халкидики по-удобен.</p><h2>Кой печели?</h2><p>Семейства → Халкидики. Парти → Скиатос.</p>`,
      ru: `<h2>Халкидики или Скиатос?</h2><p>Скиатос (49 км²) — небольшой остров Спорад. Халкидики — полуостров с 3 "ногами" и 500 км побережья.</p><h2>Доступ</h2><p>Халкидики: 1 час от SKG, без парома. Скиатос: JSI или паром из Волоса.</p><h2>Пляжи</h2><p>Халкидики предлагает больше разнообразия — <a href="/beaches">100+ пляжей</a>.</p><h2>Цена</h2><p>Скиатос на 20-30% дороже летом.</p><h2>Семьи</h2><p>Халкидики удобнее.</p><h2>Кто побеждает?</h2><p>Семьи → Халкидики. Тусовка → Скиатос.</p>`,
      ro: `<h2>Halkidiki sau Skiathos?</h2><p>Skiathos (49 km²) — insulă mică din Sporade. Halkidiki — peninsulă cu 3 "picioare" și 500 km de coastă.</p><h2>Acces</h2><p>Halkidiki: 1 oră de la SKG, fără feribot. Skiathos: zbor JSI sau feribot din Volos.</p><h2>Plaje</h2><p>Halkidiki are mai multă varietate — <a href="/beaches">100+ plaje</a>.</p><h2>Cost</h2><p>Skiathos 20-30% mai scump vara.</p><h2>Familii</h2><p>Halkidiki mai potrivit.</p><h2>Cine câștigă?</h2><p>Familii → Halkidiki. Party → Skiathos.</p>`,
      sr: `<h2>Halkidiki ili Skiatos?</h2><p>Skiatos (49 km²) — malo ostrvo Sporada. Halkidiki — poluostrvo sa 3 "noge" i 500 km obale.</p><h2>Pristup</h2><p>Halkidiki: 1 sat od SKG, bez trajekta. Skiatos: let JSI ili trajekt iz Volosa.</p><h2>Plaže</h2><p>Halkidiki ima više raznovrsnosti — <a href="/beaches">100+ plaža</a>.</p><h2>Cena</h2><p>Skiatos 20-30% skuplji leti.</p><h2>Porodice</h2><p>Halkidiki pogodniji.</p><h2>Ko pobeđuje?</h2><p>Porodice → Halkidiki. Žurka → Skiatos.</p>`,
    },
  },
  {
    slug: 'halkidiki-vs-mykonos', icon: 'Scale', color: 'pink',
    title: { el: 'Χαλκιδική ή Μύκονος;', en: 'Halkidiki vs Mykonos', de: 'Chalkidiki oder Mykonos?', bg: 'Халкидики или Миконос?', ru: 'Халкидики или Миконос?', ro: 'Halkidiki sau Mykonos?', sr: 'Halkidiki ili Mikonos?' },
    description: { el: 'Πολυτέλεια vs οικογενειακή χαλάρωση', en: 'Glamour vs family relaxation', de: 'Glamour vs Familienurlaub', bg: 'Лукс срещу семейна релаксация', ru: 'Гламур против семейного отдыха', ro: 'Glamour vs relaxare în familie', sr: 'Glamur vs porodični odmor' },
    metaTitle: { el: 'Χαλκιδική ή Μύκονος 2026 — Πλήρης Σύγκριση', en: 'Halkidiki vs Mykonos 2026 — Full Comparison Guide', de: 'Chalkidiki vs Mykonos 2026 — Vergleich', bg: 'Халкидики или Миконос 2026 — Сравнение', ru: 'Халкидики или Миконос 2026 — Сравнение', ro: 'Halkidiki sau Mykonos 2026 — Comparație', sr: 'Halkidiki ili Mikonos 2026 — Poređenje' },
    metaDesc: { el: 'Χαλκιδική ή Μύκονος; Τιμές, νυχτερινή ζωή, παραλίες, εμπειρία — σύγκριση 2026.', en: 'Halkidiki or Mykonos? Prices, nightlife, beaches, vibe — 2026 comparison.', de: 'Chalkidiki oder Mykonos? Preise, Nachtleben, Vibe — 2026.', bg: 'Халкидики или Миконос? Цени, нощен живот — 2026.', ru: 'Халкидики или Миконос? Цены, ночная жизнь — 2026.', ro: 'Halkidiki sau Mykonos? Prețuri, viață de noapte — 2026.', sr: 'Halkidiki ili Mikonos? Cene, noćni život — 2026.' },
    content: {
      el: `<h2>Χαλκιδική ή Μύκονος;</h2><p>Διαφορετικός κόσμος. Η <strong>Μύκονος</strong> = glamour-iconic Κυκλαδίτικο νησί με beach clubs. Η <strong>Χαλκιδική</strong> = authentic ελληνική χερσόνησος, οικογενειακή.</p><h2>Τιμές — η μεγαλύτερη διαφορά</h2><p>Μύκονος: cocktail €15-25, sunbed €40-150/ημέρα. <strong>Χαλκιδική 3-5× φθηνότερα</strong>. Δείτε <a href="/costs/daily-budget">budget</a>.</p><h2>Παραλίες</h2><p>Μύκονος: Paradise, Super Paradise (party). Χαλκιδική: <a href="/best/beaches-sithonia">τυρκουάζ της Σιθωνίας</a> με πευκόφυτο σκηνικό.</p><h2>Πρόσβαση</h2><p>Χαλκιδική: 1 ώρα από SKG. Μύκονος: πτήση JMK ή ferry. <strong>Χαλκιδική 50% πιο γρήγορη</strong>.</p><h2>Νυχτερινή ζωή</h2><p>Μύκονος: world-class. Χαλκιδική: ζωντανή σε Καλλιθέα/Χανιώτη αλλά οικογενειακή.</p><h2>Οικογένειες</h2><p>Χαλκιδική ξεκάθαρα νικάει. <a href="/guide/families">Οδηγός οικογενειών</a>.</p><h2>Ποιος νικάει;</h2><p><strong>Glamour unlimited budget</strong> → Μύκονος. <strong>Όλοι οι άλλοι</strong> → Χαλκιδική.</p>`,
      en: `<h2>Halkidiki vs Mykonos</h2><p>A different world. <strong>Mykonos</strong> = iconic Cycladic glamour island with beach clubs. <strong>Halkidiki</strong> = authentic Greek peninsula, family-friendly.</p><h2>Prices — the biggest gap</h2><p>Mykonos: cocktail €15-25, sunbed €40-150/day. <strong>Halkidiki 3-5× cheaper</strong>. See <a href="/costs/daily-budget">budget</a>.</p><h2>Beaches</h2><p>Mykonos: Paradise, Super Paradise (party scene). Halkidiki: <a href="/best/beaches-sithonia">Sithonia's turquoise coves</a> with pine forest backdrop.</p><h2>Access</h2><p>Halkidiki: 1 hour from SKG. Mykonos: JMK flight or 3h ferry. <strong>Halkidiki 50% faster</strong>.</p><h2>Nightlife</h2><p>Mykonos: world-class. Halkidiki: lively but family-friendly.</p><h2>Families</h2><p>Halkidiki clearly wins. See <a href="/guide/families">family guide</a>.</p><h2>Who wins?</h2><p><strong>Glamour + unlimited budget</strong> → Mykonos. <strong>Everyone else</strong> → Halkidiki.</p>`,
      de: `<h2>Chalkidiki oder Mykonos?</h2><p>Andere Welten. Mykonos = Glamour-Insel. Chalkidiki = authentische Halbinsel, familienfreundlich.</p><h2>Preise</h2><p>Chalkidiki 3-5× günstiger als Mykonos.</p><h2>Strände</h2><p>Beide schön — Chalkidiki mit Kiefernkulisse.</p><h2>Anreise</h2><p>Chalkidiki: 1 Std. ab SKG. Mykonos: Flug oder Fähre.</p><h2>Familien</h2><p>Chalkidiki klar besser.</p><h2>Wer gewinnt?</h2><p>Glamour mit Budget → Mykonos. Sonst → Chalkidiki.</p>`,
      bg: `<h2>Халкидики или Миконос?</h2><p>Различен свят. Миконос — лукс остров. Халкидики — автентичен полуостров, семеен.</p><h2>Цени</h2><p>Халкидики 3-5× по-евтин от Миконос.</p><h2>Плажове</h2><p>Халкидики с борови гори.</p><h2>Достъп</h2><p>Халкидики: 1 час от SKG. Миконос: полет или ферибот.</p><h2>Семейства</h2><p>Халкидики ясно печели.</p><h2>Кой печели?</h2><p>Неограничен лукс → Миконос. Други → Халкидики.</p>`,
      ru: `<h2>Халкидики или Миконос?</h2><p>Разные миры. Миконос — гламурный остров. Халкидики — аутентичный полуостров, семейный.</p><h2>Цены</h2><p>Халкидики в 3-5× дешевле Миконоса.</p><h2>Пляжи</h2><p>Халкидики с сосновыми лесами.</p><h2>Доступ</h2><p>Халкидики: 1 час от SKG. Миконос: рейс или паром.</p><h2>Семьи</h2><p>Халкидики явно побеждает.</p><h2>Кто побеждает?</h2><p>Гламур + бюджет → Миконос. Остальные → Халкидики.</p>`,
      ro: `<h2>Halkidiki sau Mykonos?</h2><p>Lumi diferite. Mykonos — insulă glamour. Halkidiki — peninsulă autentică, pentru familii.</p><h2>Prețuri</h2><p>Halkidiki de 3-5× mai ieftin decât Mykonos.</p><h2>Plaje</h2><p>Halkidiki cu pini.</p><h2>Acces</h2><p>Halkidiki: 1 oră de la SKG. Mykonos: zbor sau feribot.</p><h2>Familii</h2><p>Halkidiki câștigă clar.</p><h2>Cine câștigă?</h2><p>Glamour + buget → Mykonos. Restul → Halkidiki.</p>`,
      sr: `<h2>Halkidiki ili Mikonos?</h2><p>Različiti svetovi. Mikonos — glamur ostrvo. Halkidiki — autentičan poluostrvo, porodični.</p><h2>Cene</h2><p>Halkidiki 3-5× jeftiniji od Mikonosa.</p><h2>Plaže</h2><p>Halkidiki sa borovima.</p><h2>Pristup</h2><p>Halkidiki: 1 sat od SKG. Mikonos: let ili trajekt.</p><h2>Porodice</h2><p>Halkidiki jasno pobeđuje.</p><h2>Ko pobeđuje?</h2><p>Glamur + budžet → Mikonos. Ostali → Halkidiki.</p>`,
    },
  },
  {
    slug: 'halkidiki-vs-santorini', icon: 'Scale', color: 'amber',
    title: { el: 'Χαλκιδική ή Σαντορίνη;', en: 'Halkidiki vs Santorini', de: 'Chalkidiki oder Santorin?', bg: 'Халкидики или Санторини?', ru: 'Халкидики или Санторини?', ro: 'Halkidiki sau Santorini?', sr: 'Halkidiki ili Santorini?' },
    description: { el: 'Παραλίες & beach holiday vs caldera views', en: 'Beach holiday vs iconic caldera views', de: 'Strandurlaub vs Caldera-Aussicht', bg: 'Плажна почивка срещу гледки от калдера', ru: 'Пляжный отдых против видов на кальдеру', ro: 'Vacanță la plajă vs vederi calderă', sr: 'Plažni odmor vs pogledi na kalderu' },
    metaTitle: { el: 'Χαλκιδική ή Σαντορίνη 2026 — Πλήρης Σύγκριση', en: 'Halkidiki vs Santorini 2026 — Full Comparison Guide', de: 'Chalkidiki vs Santorin 2026 — Vergleich', bg: 'Халкидики или Санторини 2026 — Сравнение', ru: 'Халкидики или Санторини 2026 — Сравнение', ro: 'Halkidiki sau Santorini 2026 — Comparație', sr: 'Halkidiki ili Santorini 2026 — Poređenje' },
    metaDesc: { el: 'Χαλκιδική ή Σαντορίνη; Παραλίες, ηλιοβασιλέματα, ζευγάρια, κόστος — σύγκριση 2026.', en: 'Halkidiki or Santorini? Beaches, sunsets, couples, cost — 2026 comparison.', de: 'Chalkidiki oder Santorin? Strände, Sonnenuntergänge — 2026.', bg: 'Халкидики или Санторини? Плажове, залези — 2026.', ru: 'Халкидики или Санторини? Пляжи, закаты — 2026.', ro: 'Halkidiki sau Santorini? Plaje, apusuri — 2026.', sr: 'Halkidiki ili Santorini? Plaže, zalasci — 2026.' },
    content: {
      el: `<h2>Χαλκιδική ή Σαντορίνη;</h2><p>Διαφορετική εμπειρία. <strong>Σαντορίνη</strong> = iconic caldera, λευκοκυανές εκκλησίες, world-famous sunset σε Οία. <strong>Χαλκιδική</strong> = πραγματικές παραλίες για κολύμπι, πευκοδάση, value-for-money.</p><h2>Παραλίες — η μεγάλη διαφορά</h2><p>Σαντορίνη: μαύρη/κόκκινη βολκανική άμμος, περιορισμένες. Χαλκιδική: <a href="/best/beaches-sithonia">τυρκουάζ νερά + λευκή άμμος + πευκόφυτο</a> — αν η παραλία είναι προτεραιότητα, <strong>Χαλκιδική νικάει</strong>.</p><h2>Ηλιοβασίλεμα</h2><p>Σαντορίνη: bucket-list αλλά υπερτουριστικό. Χαλκιδική: <a href="/guide/sunset-spots">10+ ησυχα σημεία</a> χωρίς πλήθη.</p><h2>Κόστος</h2><p>Σαντορίνη 2-4× ακριβότερη. Cave suite €400-1500/βράδυ. Χαλκιδική: ίδιο luxury €100-300.</p><h2>Πρόσβαση</h2><p>Χαλκιδική: 1 ώρα από SKG. Σαντορίνη: πτήση JTR ή 8h ferry.</p><h2>Ζευγάρια</h2><p>Σαντορίνη για caldera moments. Χαλκιδική για romantic chill + value. <a href="/guide/honeymoon">Μήνα του μέλιτος</a>.</p><h2>Οικογένειες</h2><p>Σαντορίνη ΟΧΙ — απότομα μονοπάτια. Χαλκιδική ξεκάθαρα.</p><h2>Ποιος νικάει;</h2><p><strong>Insta + caldera</strong> → Σαντορίνη. <strong>Παραλίες + value</strong> → Χαλκιδική.</p>`,
      en: `<h2>Halkidiki vs Santorini</h2><p>A very different experience. <strong>Santorini</strong> = iconic caldera, white-and-blue churches, world-famous Oia sunset. <strong>Halkidiki</strong> = real swimming beaches, pine forests, exceptional value.</p><h2>Beaches — the big gap</h2><p>Santorini: black/red volcanic sand, limited options. Halkidiki: <a href="/best/beaches-sithonia">turquoise water + white sand + pine backdrop</a> — if the beach is your priority, <strong>Halkidiki wins easily</strong>.</p><h2>Sunsets</h2><p>Santorini: bucket-list, but overcrowded. Halkidiki: <a href="/guide/sunset-spots">10+ quiet spots</a> without the crowds.</p><h2>Cost</h2><p>Santorini 2-4× more expensive. Cave suite €400-1500/night. Halkidiki: same luxury for €100-300.</p><h2>Access</h2><p>Halkidiki: 1 hour from SKG. Santorini: JTR flight or 8h ferry from Piraeus.</p><h2>Couples</h2><p>Santorini for caldera moments. Halkidiki for romantic chill + value. See <a href="/guide/honeymoon">honeymoon guide</a>.</p><h2>Families</h2><p>Santorini NOT recommended — steep cliffs. Halkidiki clearly wins.</p><h2>Who wins?</h2><p><strong>Instagram + caldera</strong> → Santorini. <strong>Beaches + value + families</strong> → Halkidiki.</p>`,
      de: `<h2>Chalkidiki oder Santorin?</h2><p>Andere Erfahrung. Santorin = ikonische Caldera. Chalkidiki = echte Badestrände, gutes Preis-Leistungs.</p><h2>Strände</h2><p>Chalkidiki gewinnt für Strände — türkis + Kiefern.</p><h2>Sonnenuntergänge</h2><p>Santorin: überfüllt. Chalkidiki: ruhige Spots.</p><h2>Kosten</h2><p>Santorin 2-4× teurer.</p><h2>Anreise</h2><p>Chalkidiki: 1 Std. SKG. Santorin: Flug oder Fähre.</p><h2>Wer gewinnt?</h2><p>Caldera-Wow → Santorin. Strände + Value → Chalkidiki.</p>`,
      bg: `<h2>Халкидики или Санторини?</h2><p>Различно изживяване. Санторини = калдера. Халкидики = плажове за плуване, добра цена.</p><h2>Плажове</h2><p>Халкидики печели — тюркоаз + борови.</p><h2>Залези</h2><p>Санторини: пренаселено. Халкидики: тихи места.</p><h2>Цена</h2><p>Санторини 2-4× по-скъп.</p><h2>Достъп</h2><p>Халкидики: 1 час от SKG. Санторини: полет или ферибот.</p><h2>Кой печели?</h2><p>Калдера-уау → Санторини. Плажове → Халкидики.</p>`,
      ru: `<h2>Халкидики или Санторини?</h2><p>Разный опыт. Санторини = кальдера. Халкидики = настоящие пляжи, отличная цена.</p><h2>Пляжи</h2><p>Халкидики побеждает — бирюзовая вода + сосны.</p><h2>Закаты</h2><p>Санторини: переполнено. Халкидики: тихие места.</p><h2>Цена</h2><p>Санторини в 2-4× дороже.</p><h2>Доступ</h2><p>Халкидики: 1 час от SKG. Санторини: рейс или паром.</p><h2>Кто побеждает?</h2><p>Кальдера-вау → Санторини. Пляжи → Халкидики.</p>`,
      ro: `<h2>Halkidiki sau Santorini?</h2><p>Experiență diferită. Santorini = calderă. Halkidiki = plaje reale, valoare bună.</p><h2>Plaje</h2><p>Halkidiki câștigă — turcoaz + pini.</p><h2>Apusuri</h2><p>Santorini: aglomerat. Halkidiki: locuri liniștite.</p><h2>Cost</h2><p>Santorini de 2-4× mai scump.</p><h2>Acces</h2><p>Halkidiki: 1 oră de la SKG. Santorini: zbor sau feribot.</p><h2>Cine câștigă?</h2><p>Calderă-wow → Santorini. Plaje → Halkidiki.</p>`,
      sr: `<h2>Halkidiki ili Santorini?</h2><p>Drugačije iskustvo. Santorini = kaldera. Halkidiki = prave plaže, dobra vrednost.</p><h2>Plaže</h2><p>Halkidiki pobeđuje — tirkiz + borovi.</p><h2>Zalasci</h2><p>Santorini: prepuno. Halkidiki: mirna mesta.</p><h2>Cena</h2><p>Santorini 2-4× skuplji.</p><h2>Pristup</h2><p>Halkidiki: 1 sat od SKG. Santorini: let ili trajekt.</p><h2>Ko pobeđuje?</h2><p>Kaldera-vau → Santorini. Plaže → Halkidiki.</p>`,
    },
  },
  {
    ...
    metaTitle: { el: 'Χαλκιδική ή Κρήτη; Σύγκριση 2026', en: 'Halkidiki vs Crete 2026 — Full Comparison', de: 'Chalkidiki vs Kreta 2026 — Vergleich', bg: 'Халкидики или Крит 2026 — Сравнение', ru: 'Халкидики или Крит 2026 — Сравнение', ro: 'Halkidiki vs Creta 2026 — Comparație', sr: 'Halkidiki ili Krit 2026 — Poređenje' },
...
<p>Atos, zatim Sitonija, zatim Kasandra. <a href="/guide/budget">Budžet</a>.</p>`,
  ...
  },
  {
    ...
    metaTitle: { el: 'Πεζοπορία Χαλκιδική 2026 — Διαδρομές, Μονοπάτια, Δυσκολία', en: 'Hiking Halkidiki 2026 — Trails, Routes, Difficulty', de: 'Wandern Chalkidiki 2026 — Routen, Wege', bg: 'Планинарство Халкидики 2026 — Маршрути', ru: 'Пешие походы Халкидики 2026', ro: 'Drumeții Halkidiki 2026 — Rute', sr: 'Planinarenje Halkidiki 2026' },
...
<p>Lake staze. Vidi <a href="/guide/families">porodice</a>.</p>`,
  ...
  },
  {
    ...
    metaTitle: { el: 'Οινοτουρισμός Χαλκιδική 2026 — Οινοποιεία, Δοκιμές, Tours', en: 'Wine Tours Halkidiki 2026 — Wineries, Tastings', de: 'Weintourismus Chalkidiki 2026', bg: 'Винен туризъм Халкидики 2026', ru: 'Винный туризм Халкидики 2026', ro: 'Tururi viticole Halkidiki 2026', sr: 'Vinski turizam Halkidiki 2026' },
...
<p>€10-35. Vidi <a href="/guide/food-and-wine">hrana i vino</a>.</p>`,
  ...
  },
  {
    ...
    metaTitle: { el: 'Σπήλαιο Πετραλώνων 2026 — Ώρες, Εισιτήρια, Ιστορία', en: 'Petralona Cave 2026 — Hours, Tickets, History', de: 'Petralona-Höhle 2026 — Öffnungszeiten, Tickets', bg: 'Пещерата Петралона 2026 — Часове, Билети', ru: 'Пещера Петралона 2026 — Часы, Билеты', ro: 'Peștera Petralona 2026 — Orar, Bilete', sr: 'Pećina Petralona 2026 — Radno vreme, Karte' },
